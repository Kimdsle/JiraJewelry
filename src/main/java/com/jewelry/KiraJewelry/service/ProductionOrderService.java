...
public class ProductionOrderService {
  ...
  public double getRevenueChangePercentage() {
    ...
    Double thisMonthRevenue = productionOrderRepository.sumTotalAmountByThisMonth();
    ...
    if (lastMonthRevenue == 0) {
      return 100.0; // If there was no revenue last month, the change is considered as 100%
    }
